...
ActiveRecord::Schema[8.0].define(version: 2025_07_25_053321) do
  ...
  create_table "order_items", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["grocery_item_id"], name: "index_order_items_on_grocery_item_id"
  ...
  create_table "recipe_items", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "recipe_id", null: false
    t.bigint "grocery_item_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["grocery_item_id"], name: "index_recipe_items_on_grocery_item_id"
  ...
  add_foreign_key "order_items", "grocery_items"
  add_foreign_key "order_items", "orders"
  add_foreign_key "orders", "users"
  add_foreign_key "pantry_items", "users"
  add_foreign_key "recipe_items", "grocery_items"
